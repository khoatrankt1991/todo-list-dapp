...
const nextConfig: NextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_CONTRACT_ADDRESS_MONAD: process.env.NEXT_PUBLIC_CONTRACT_ADDRESS_MONAD || '',
    NEXT_PUBLIC_CONTRACT_ADDRESS_POLYGON_AMOY: process.env.NEXT_PUBLIC_CONTRACT_ADDRESS_POLYGON_AMOY || '',
